...
if dblp.ae_data_exist(file_path='../dataset/ae_t2v_dimSkill{}_dimUser{}_tFull_dataset_IMDB.pkl'.format(embedding_dim_skill, embedding_dim_user)):
    dataset = dblp.load_ae_dataset(file_path='../dataset/ae_t2v_dimSkill{}_dimUser{}_tFull_dataset_IMDB.pkl'.format(embedding_dim_skill, embedding_dim_user))
else:
    ...
    preprocessed_dataset = dblp.load_preprocessed_dataset(file_path='../dataset/imdb/imdb.pkl')

    dblp.nn_t2v_dataset_generator({'skill':t2v_model_skill, 'user':t2v_model_user}, preprocessed_dataset,
                                  output_file_path='../dataset/ae_t2v_dimSkill{}_dimUser{}_tFull_dataset_IMDB.pkl'
...
result_output_name = "../output/predictions/{}_{}_output.csv".format(dataset_name, method_name)
...
train_test_indices = dblp.load_train_test_indices(file_path='../dataset/imdb/imdb_train_test_indices.pkl')
